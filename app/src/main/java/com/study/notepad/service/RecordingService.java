package com.study.notepad.service;
...
import com.study.notepad.util.SharedPreferenceUtil;
...
public class RecordingService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        mDatabase = new DataBaseUtil(getApplicationContext());
        Logger.i("onCreate");
    }
    ...
    public void startRecording() {
        ...
        if (SharedPreferenceUtil.getPrefHighQuality(this)) {
    ...
    public void setFileNameAndPath() {
        ...
        do {
            ...
            mFilePath += "/notePadRecorder/" + mFileName;
    ...
    private Notification createNotification() {
        ...
        mBuilder.setContentIntent(PendingIntent.getActivities(getApplicationContext(), 0,
                new Intent[]{new Intent(getApplicationContext(), PublishSpeechActivity.class)}, 0));
